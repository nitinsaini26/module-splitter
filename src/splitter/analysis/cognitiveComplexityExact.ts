 ...
 */
export function cognitiveComplexityExact(src: string, fileName = '__astra__.ts'): number {
        ...
        switch (node.kind) {
            ...
            case ts.SyntaxKind.IfStatement: {
                ...
                if (ifNode.elseStatement) {
                    ...
                    const innerNesting = ts.isIfStatement(elseBody) ? nesting : nesting + 1;
